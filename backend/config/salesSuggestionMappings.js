/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║        SALES SUGGESTION MAPPINGS — STATIC FALLBACK DATA        ║
 * ╠══════════════════════════════════════════════════════════════════╣
 * ║  Static co-occurrence hints used when a user has no history.    ║
 * ║  Dynamic (DB) co-occurrence always takes priority.              ║
 * ║                                                                  ║
 * ║  Format: field → value → { relatedField: [suggested values] }  ║
 * ╚══════════════════════════════════════════════════════════════════╝
 */
...
/**
 * Get static fallback suggestions for a target field given form context.
 *
 * @param {string} targetField — the field to suggest values for
 * @param {Object} context — current form values ({ platform: 'Upwork', ... })
 * @returns {string[]} — unique ordered suggestions
 */
