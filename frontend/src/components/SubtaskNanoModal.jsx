...
const SubtaskNanoModal = ({
  ...
  const loadNano = async () => {
    try {
      const response = await Database.getNano(entityId);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error("Error saving nano subtask:", error);
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-xl w-full max-w-4xl mt-4 mb-4 shadow-2xl max-h-[95vh] overflow-y-auto relative"
        >
...
export default SubtaskNanoModal;