...
import { 
  ...
  User, Save, Plus, TrendingUp, FileText, Eye, Copy,
  Archive, Share2, Bell
} from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-2xl w-full max-w-6xl my-8 mx-4 shadow-2xl"
        ...
        >
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1 pr-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600 mb-3">
                  ...
                  <span>{card.list?.title || 'List'}</span>
                </div>
                
                {/* Title */}
                <div className="flex items-start gap-3">
                  <AlignLeft size={24} className="text-gray-600 mt-2 flex-shrink-0" />
                  <input
                    type="text"
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    className="text-3xl font-bold w-full bg-transparent border-none outline-none focus:bg-gray-50 rounded px-2 py-1 -ml-2 text-gray-900 transition-colors"
          ...
          <div className="flex">
            ...
            <div className="flex-1 p-6 space-y-6 overflow-y-auto max-h-[calc(100vh-200px)]">
              ...
              {labels.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  <Tag size={16} className="text-gray-600 mt-1" />
                ...
                {isEditingDescription || description ? (
                  <div className="ml-8">
                    <textarea
                      ...
                      className="w-full p-4 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700 transition-all"
                      rows="5"
                    />
                  </div>
                ) : (
                  <button
                    ...
                    className="ml-8 w-full text-left p-4 bg-gray-50 hover:bg-gray-100 rounded-xl text-sm text-gray-600 transition-colors border border-dashed border-gray-300"
                  >
            ...
            {/* Sidebar */}
            <div className="w-80 border-l border-gray-200 p-6 space-y-4 bg-gray-50">
              {/* Save Button */}
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={handleSave}
                disabled={saving}
                className="flex items-center justify-center gap-2 w-full p-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg disabled:opacity-50 font-medium"
              >
                <Save size={18} />
              ...
              <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                ...
                <div className="space-y-2">
                  {/* Members */}
                  <button className="w-full flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg text-sm text-gray-700 transition-colors">
                    <Users size={16} />
                    Members
                  </button>
                  ...
                  <button 
                    ...
                    className="w-full flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg text-sm text-gray-700 transition-colors"
                  >
                    <Tag size={16} />
                    Labels
                  </button>
