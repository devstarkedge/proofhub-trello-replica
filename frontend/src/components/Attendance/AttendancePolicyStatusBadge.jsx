...
/** DRAFT / SCHEDULED / ACTIVE / INACTIVE / ARCHIVED — the full AttendancePolicy.status vocabulary, one look everywhere it's shown. */
const AttendancePolicyStatusBadge = ({ status }) => {
...
export default AttendancePolicyStatusBadge;
